...
/// Validate if a provided ECDSA signature is valid across a provided public key
...
/// Recover an ethereum address from an ECDSA signature and message
...
/// preprocess an ethereum message before using it to derive a public key
...
mod tests {
    ...
    fn test_validate_signature() {
        ...
        let expected_signature = "eeae5aee33e7ae31c84ff37dd85e1e25d8750a2b8598c67795b6246e18cb8ffe1b45b9e394b57e0b840e6d8e8b501c75a44b4580904660f11c8a435bbb8a37411c".to_string();

        let is_valid = validate_ecdsa_signature(&expected_signature, &message, &public_key).unwrap();
