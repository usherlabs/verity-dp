...
//!
//! ```no_run
//! # use verity_verify_tls::tlsn_core::transcript::{TranscriptCommitConfigBuilder, Transcript, Direction};
//! # use verity_verify_tls::tlsn_core::hash::HashAlgId;
...
//!
//! ```no_run
//! # use verity_verify_tls::tlsn_core::presentation::Presentation;
//! # use verity_verify_tls::tlsn_core::attestation::Attestation;
//! # use verity_verify_tls::tlsn_core::transcript::{TranscriptCommitmentKind, Direction};
//! # use verity_verify_tls::tlsn_core::{Secrets, CryptoProvider};
...
//!
//! ```no_run
//! # use verity_verify_tls::tlsn_core::presentation::{Presentation, PresentationOutput};
//! # use verity_verify_tls::tlsn_core::signing::VerifyingKey;
//! # use verity_verify_tls::tlsn_core::CryptoProvider;
//! # #[cfg(not(feature = "private-facets"))]
//! # fn main() { }
...
//!     transcript,
//!     ..
//! } = presentation.verify_private_facets(&crypto_provider)?;
//! # Ok(())
//! # }
//! ```
