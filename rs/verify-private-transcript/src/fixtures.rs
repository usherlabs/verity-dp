...
use crate::fixtures_data::provider::ChaChaProvider;
...
impl ConnectionFixture {
    ...
    pub fn tlsnotary(transcript_length: TranscriptLength) -> Self {
        ConnectionFixture {
            ...
            server_cert_data: ServerCertData {
                certs: vec![
                    Certificate(include_bytes!("fixtures_data/data/tlsnotary.org/ee.der").to_vec()),
                    Certificate(include_bytes!("fixtures_data/data/tlsnotary.org/inter.der").to_vec()),
                    Certificate(include_bytes!("fixtures_data/data/tlsnotary.org/ca.der").to_vec()),
                ],
                sig: ServerSignature {
                    scheme: SignatureScheme::RSA_PKCS1_SHA256,
                    sig: Vec::<u8>::from_hex(include_bytes!(
                        "fixtures_data/data/tlsnotary.org/signature"
                    ))
                    .unwrap(),
                },
                handshake: HandshakeData::V1_2(HandshakeDataV1_2 {
                    client_random: <[u8; 32]>::from_hex(include_bytes!(
                        "fixtures_data/data/tlsnotary.org/client_random"
                    ))
                    .unwrap(),
                    server_random: <[u8; 32]>::from_hex(include_bytes!(
                        "fixtures_data/data/tlsnotary.org/server_random"
                    ))
                    .unwrap(),
                    server_ephemeral_key: ServerEphemKey {
                        typ: KeyType::SECP256R1,
                        key: Vec::<u8>::from_hex(include_bytes!(
                            "fixtures_data/data/tlsnotary.org/pubkey"
                        ))
                        .unwrap(),
                    },
                }),
    ...
    pub fn appliedzkp(transcript_length: TranscriptLength) -> Self {
        ConnectionFixture {
            ...
            server_cert_data: ServerCertData {
                certs: vec![
                    Certificate(include_bytes!("fixtures_data/data/appliedzkp.org/ee.der").to_vec()),
                    Certificate(include_bytes!("fixtures_data/data/appliedzkp.org/inter.der").to_vec()),
                    Certificate(include_bytes!("fixtures_data/data/appliedzkp.org/ca.der").to_vec()),
                ],
                sig: ServerSignature {
                    scheme: SignatureScheme::ECDSA_NISTP256_SHA256,
                    sig: Vec::<u8>::from_hex(include_bytes!(
                        "fixtures_data/data/appliedzkp.org/signature"
                    ))
                    .unwrap(),
                },
                handshake: HandshakeData::V1_2(HandshakeDataV1_2 {
                    client_random: <[u8; 32]>::from_hex(include_bytes!(
                        "fixtures_data/data/appliedzkp.org/client_random"
                    ))
                    .unwrap(),
                    server_random: <[u8; 32]>::from_hex(include_bytes!(
                        "fixtures_data/data/appliedzkp.org/server_random"
                    ))
                    .unwrap(),
                    server_ephemeral_key: ServerEphemKey {
                        typ: KeyType::SECP256R1,
                        key: Vec::<u8>::from_hex(include_bytes!(
                            "fixtures_data/data/appliedzkp.org/pubkey"
                        ))
                        .unwrap(),
                    },
                }),
