...
//!
//! ```no_run
//! # use verity_verify_private_transcript::transcript::{TranscriptCommitConfigBuilder, Transcript, Direction};
//! # use verity_verify_private_transcript::hash::HashAlgId;
...
//!
//! ```no_run
//! # use verity_verify_private_transcript::presentation::Presentation;
//! # use verity_verify_private_transcript::attestation::Attestation;
//! # use verity_verify_private_transcript::transcript::{TranscriptCommitmentKind, Direction};
//! # use verity_verify_private_transcript::{Secrets, CryptoProvider};
//! # fn main() -> Result<(), Box<dyn std::error::Error>> {
...
//!
//! ```no_run
//! # use verity_verify_private_transcript::presentation::{Presentation, PresentationOutput};
//! # use verity_verify_private_transcript::signing::VerifyingKey;
//! # use verity_verify_private_transcript::CryptoProvider;
//! # fn main() -> Result<(), Box<dyn std::error::Error>> {
